...
- **Piloto validado end-to-end** (proyecto "Perfil GEO · Carlos Ortet", jul 2026): 156/156 tasks sin fallos; el módulo detectó visibilidad orgánica nula en el nicho, una colisión de nombre de producto con un término genérico y LinkedIn como fuente real del motor con retrieval (39 citas). Lección metodológica incorporada: un presunto dato "alucinado" debe contrastarse contra las fuentes propias del sujeto antes de marcarlo como error (en el piloto resultó ser información correcta publicada en la web del sujeto).
